...
"""
content = content.replace("        :root {", css_add + "\n        :root {")

# 2. Add buttons to nav
nav_btns = """
...
"""
content = content.replace('<a href="#contact" class="btn-sm" style="background: rgba(255,255,255,0.05); border: 1px solid var(--border); color: var(--text);">Pitch Deck</a>',
...
"""
content = content.replace("        lucide.createIcons();", js_add + "\n        lucide.createIcons();")
